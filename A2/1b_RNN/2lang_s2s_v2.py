...
class seq2seq():
    ...
    def twolang(self, act_func, loss_func, latent_dim=256):
        ...
        self.dec_model = Model([frdecoder_inputs, dedecoder_inputs] + [frdecoder_states_inputs, dedecoder_states_inputs],
                               [frdecoder_outputs, dedecoder_outputs] + [frdecoder_states, dedecoder_states])
    ...
    def fit(self, pre, batch_sz=64, epochs=100):
        self.model.fit([self.data.encoder_input_data,
                       ...
                       [self.data.frdecoder_target_data, self.data.dedecover_target_data],
                       batch_size=batch_sz,
                       epochs=epochs,
